                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="<?php echo e(route('manage-comments')); ?>"><i class="fa fa-comment"></i> Comments</a>
                            </li>
                            <li>
                                <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Category Info<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="<?php echo e(route('create-category')); ?>">Add Category</a>
                                    </li>
                                    <li>
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="<?php echo e(route('create-blog')); ?>">Add Post</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('manage-blog')); ?>">Manage Post</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
